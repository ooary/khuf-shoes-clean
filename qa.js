...
(async()=>{
 ...
 const before=await page.$eval('#reviewTrack',e=>e.scrollLeft); await page.click('#reviewNext'); await page.waitForTimeout(700); const after=await page.$eval('#reviewTrack',e=>e.scrollLeft); if(after<=before) throw Error('carousel next failed');
