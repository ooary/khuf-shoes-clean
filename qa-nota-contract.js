...
for (const forbidden of ['0812-4432-8821','081244328821','Pejaten Barat, Jakarta Selatan','Status Pengerjaan','Dalam Proses','Siap Diambil']) {
...
assert(cashierJs.includes('/nota/khf_7M2pQ9xR4vN8'), 'cashier WhatsApp must include demo nota URL');
